...
const modules = [
  { icon: "🔁", title: "Pipeline", desc: "Satış adımlarınızı sürükle-bırak ile yönetin." },
  { icon: "👥", title: "Müşteriler", desc: "İletişim geçmişi, notlar ve hatırlatıcılar." },
  { icon: "✅", title: "Görevler", desc: "Takım ve bireysel görev yönetimi." },
  { icon: "📊", title: "Raporlama", desc: "Anlık panel ve özelleştirilebilir raporlar." },
  { icon: "📧", title: "E-posta Entegrasyonu", desc: "Gelen kutusunuzu CRM ile senkronize edin." },
  { icon: "🔔", title: "Bildirimler", desc: "Önemli aktivitelerde anında uyarı alın." },
];
